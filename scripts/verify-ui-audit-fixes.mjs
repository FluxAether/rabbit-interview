...
assert.match(dashboard, /dashboard.readiness.title/)
assert.match(history, /history.strengths/)
assert.match(panel, /copilot.clearConfirm/)
assert.match(stealth, /capabilitiesError/)
