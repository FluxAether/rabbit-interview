...
mod tests {
    ...
    fn payment_config(private_key: String, public_key: String) -> Config {
        Config {
            ...
            oidc_client_id: "oncue-desktop".to_owned(),
            oidc_redirect_uri: "oncuedesktop://auth/callback".to_owned(),
            oidc_post_logout_redirect_uri: "oncuedesktop://auth/logout".to_owned(),
