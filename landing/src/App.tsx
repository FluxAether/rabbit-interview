...
import { Apple, ArrowUpRight, Menu, Moon, Sun, X } from 'lucide-react'
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-10 px-5 py-16 lg:grid-cols-[1fr_1fr] lg:gap-12 lg:py-24">
            ...
            >
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                ...
                <a
                  href={DOWNLOAD.win}
                  className="inline-flex h-12 items-center gap-2 rounded-2xl border border-line bg-subtle px-5 text-sm font-medium text-ink transition-colors hover:border-ink/20"
                >
                ...
                <a
                  href={DOWNLOAD.repo}
                  className="inline-flex h-12 items-center gap-2 rounded-2xl border border-line bg-subtle px-5 text-sm text-ink transition-colors hover:border-ink/20"
                >
